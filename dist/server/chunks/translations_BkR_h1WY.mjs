import { bm as renderElement, at as generateCspDigest, x as spreadAttributes, bf as unescapeHTML, a4 as renderTemplate, bn as removeBase, aT as isRemotePath, A as AstroError, bo as LiveContentConfigError, aQ as AstroUserError, aj as unflatten, b3 as object, bc as date, bl as array, bp as UnknownContentCollectionError, bq as RenderUndefinedEntryError, br as escape$1, b1 as string, aB as prependForwardSlash, bs as createHeadAndContent, a3 as renderComponent, b2 as strictObject } from './sequence_BHhiZ0XQ.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Cp7_g0YI.mjs');
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_CrL3FODn.mjs');
...
const config = {"logo":{"dark":"./src/assets/logo-dark.svg","light":"./src/assets/logo-light.svg","alt":"","replacesTitle":true},"social":[],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"titleDelimiter":"|","title":{"fr":"Documentation Team IT"},"isMultilingual":false,"defaultLocale":{"label":"Français","lang":"fr","dir":"ltr"}};
