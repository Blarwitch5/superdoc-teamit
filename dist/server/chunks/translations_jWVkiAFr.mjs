import { bm as renderElement, at as generateCspDigest, x as spreadAttributes, bg as unescapeHTML, a4 as renderTemplate, bn as removeBase, aT as isRemotePath, A as AstroError, bo as LiveContentConfigError, aQ as AstroUserError, aj as unflatten, a_ as object, b7 as date, bl as array, bp as UnknownContentCollectionError, bq as RenderUndefinedEntryError, br as escape$1, aY as string, aB as prependForwardSlash, bs as createHeadAndContent, a3 as renderComponent, aZ as strictObject } from './sequence_DUL7TRkU.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_m0DxR_Fq.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_BnuNtTy8.mjs');
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_aqkTWRMZ.mjs');
...
const config = {"logo":{"dark":"./src/assets/logo-dark.svg","light":"./src/assets/logo-light.svg","alt":"","replacesTitle":true},"social":[],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Administratif","translations":{},"collapsed":false,"autogenerate":{"directory":"administratif","attrs":{}}},{"label":"Email","translations":{},"collapsed":false,"autogenerate":{"directory":"email","attrs":{}}},{"label":"Installation","translations":{},"collapsed":false,"autogenerate":{"directory":"installation","attrs":{}}},{"label":"Serveur","translations":{},"collapsed":false,"autogenerate":{"directory":"serveur","attrs":{}}},{"label":"Web","translations":{},"collapsed":false,"autogenerate":{"directory":"web","attrs":{}}}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","title":{"fr":"Documentation Team IT"},"isMultilingual":false,"defaultLocale":{"label":"Français","lang":"fr","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///Users/blarwitch/Sites/teamit/teamit-superdoc/","srcDir":"file:///Users/blarwitch/Sites/teamit/teamit-superdoc/src/","trailingSlash":"ignore"};
...
export { BuiltInDefaultLocale as B, CONTENT_LAYER_TYPE as C, LIVE_CONTENT_TYPE as L, createSvgComponent as a, stripTrailingSlash as b, config as c, stripLeadingSlash as d, ensureHtmlExtension as e, stripHtmlExtension as f, getCollectionPathFromRoot as g, ensureTrailingSlash as h, getCollection as i, pickLang as j, ensureLeadingSlash as k, stripExtension as l, getEntry as m, defineCollection as n, project as p, renderEntry as r, stripLeadingAndTrailingSlashes as s, useTranslations as u };
