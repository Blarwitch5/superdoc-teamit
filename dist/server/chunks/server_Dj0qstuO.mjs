...
const pageMap = new Map([
    ...
    ["src/pages/api/admin/user.ts", _page7],
    ["src/pages/api/auth/[...all].ts", _page8],
    ["src/pages/api/keystatic/[...params].ts", _page9],
    ["src/pages/api/search.ts", _page10],
    ["src/pages/change-password.astro", _page11],
