...
const $$ChangePassword = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "AppLayout", $$AppLayout, { "title": "Changer le mot de passe — Documentation Team IT", "class": "astro-vbnpqbnz" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="page astro-vbnpqbnz"> <header class="top-bar astro-vbnpqbnz"> <a href="/" class="logo-link astro-vbnpqbnz"> <div class="logo-bg astro-vbnpqbnz">${renderComponent($$result2, "TeamItLogo", $$TeamItLogo, { "height": 24, "aria-hidden": true, "class": "astro-vbnpqbnz" })}</div> </a> <nav class="top-nav astro-vbnpqbnz"> <a href="/admin" class="nav-link astro-vbnpqbnz">Administration</a> <a href="/logout" class="nav-link muted astro-vbnpqbnz">Déconnexion</a> </nav> </header> <main class="astro-vbnpqbnz"> <div class="card astro-vbnpqbnz"> <h1 class="card-title astro-vbnpqbnz">Changer le mot de passe</h1> <p class="card-sub astro-vbnpqbnz">${user.name || user.email}</p> ${success ? renderTemplate`<div class="success-box astro-vbnpqbnz">
